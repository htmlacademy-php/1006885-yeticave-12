        ...
        <header class="main-header">
            <div class="main-header__container container">
                ...
                <form class="main-header__search" method="get" action="search.php" autocomplete="off">
                    <input type="search" name="search" placeholder="Поиск лота" value="<?= filter_user_data($lot_search) ?>">
        ...
        <nav class="nav">
            <ul class="nav__list container">
                <?php foreach ($lots_categories as $category) : ?>
                    <li class="nav__item">
                        <a href="pages/all-lots.html"><?php filter_user_data(print($category['category_name'])); ?></a>
                    </li>
                <?php endforeach; ?>
            </ul>
        </nav>
