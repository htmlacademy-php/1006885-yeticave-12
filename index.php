...
$user_name = 'Андрей Беляев'; // укажите здесь ваше имя
$product_categories = ['Доски и лыжи', 'Крепления', 'Ботинки', 'Одежда', 'Инструменты', 'Разное'];
$products = [
    [
                ...
                <ul class="lots__list">
                    ...
                    <li class="lots__item lot">
                        ...
                        <div class="lot__info">
                            ...
                            <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?php print($product['name']); ?></a></h3>
                            <div class="lot__state">
                                <div class="lot__rate">
                                    <span class="lot__amount">Стартовая цена</span>
                                    <span class="lot__cost"><?php print(format_price($product['price'])); ?></span>
                                </div>
